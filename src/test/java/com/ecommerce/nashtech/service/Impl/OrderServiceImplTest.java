...
import com.ecommerce.nashtech.entity.OrderItem;
import com.ecommerce.nashtech.entity.Perfume;
import com.ecommerce.nashtech.repository.OrderItemRepository;
import com.ecommerce.nashtech.repository.OrderRepository;
...
import static com.ecommerce.nashtech.util.TestConstants.TOTAL_PRICE;
...
public class OrderServiceImplTest {
    ...
    public void postOrder() {
        ...
        when(perfumeRepository.findById(1L)).thenReturn(Optional.of(perfume1));
        when(perfumeRepository.findById(2L)).thenReturn(Optional.of(perfume2));
